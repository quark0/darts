...
<img src="img/progress_convolutional_reduce.gif" alt="progress_convolutional_reduce" width="30%">
<img src="img/progress_recurrent.gif" alt="progress_recurrent" width="36%">
</p>
